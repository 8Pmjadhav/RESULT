...
<body>
    <div class="contain" align="center">
        <form action="update3.php" method="post">
            <h1 style="font-size: 80px;">UPDATE RECORD</h1>
                <hr>
                <h1 class="abc">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><select name="Sub_1" id="Sub_1" required>
                                                <option value="<?php echo $rowt['Sub_1']; ?>"><?php echo $rowt['Sub_1']; ?></option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="Sub_2" id="Sub_2" required>
                                                <option value="<?php echo $rowt['Sub_2']; ?>"><?php echo $rowt['Sub_2']; ?></option>
                                                <option value="A+">A+</option>
                                                <option value="A">A</option>
                                                <option value="B+">B+</option>
                                                <option value="B">B</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="Sub_3" id="Sub_3" required>
                                                <option value="<?php echo $rowt['Sub_3']; ?>"><?php echo $rowt['Sub_3']; ?></option>
                                                <option value="A+">A+</option>
                                                <option value="A">A</option>
                                                <option value="B+">B+</option>
                                                <option value="B">B</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="Sub_4" id="Sub_4" required>
                                                <option value="<?php echo $rowt['Sub_4']; ?>"><?php echo $rowt['Sub_4']; ?></option>
                                                <option value="A+">A+</option>
                                                <option value="A">A</option>
                                                <option value="B+">B+</option>
                                                <option value="B">B</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="Sub_5" id="Sub_5" required>
                                                <option value="<?php echo $rowt['Sub_5']; ?>"><?php echo $rowt['Sub_5']; ?></option>
                                                <option value="A+">A+</option>
                                                <option value="A">A</option>
                                                <option value="B+">B+</option>
                                                <option value="B">B</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="Sub_6" id="Sub_6" required>
                                                <option value="<?php echo $rowt['Sub_6']; ?>"><?php echo $rowt['Sub_6']; ?></option>
                                                <option value="A+">A+</option>
                                                <option value="A">A</option>
                                                <option value="B+">B+</option>
                                                <option value="B">B</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="Sub_7" id="Sub_7" required>
                                                <option value="<?php echo $rowt['Sub_7']; ?>"><?php echo $rowt['Sub_7']; ?></option>
                                                <option value="A+">A+</option>
                                                <option value="A">A</option>
                                                <option value="B+">B+</option>
                                                <option value="B">B</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="Sub_8" id="Sub_8" required>
                                                <option value="<?php echo $rowt['Sub_8']; ?>"><?php echo $rowt['Sub_8']; ?></option>
                                                <option value="A+">A+</option>
                                                <option value="A">A</option>
                                                <option value="B+">B+</option>
                                                <option value="B">B</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="Sub_9" id="Sub_9" required>
                                                <option value="<?php echo $rowt['Sub_9']; ?>"><?php echo $rowt['Sub_9']; ?></option>
                                                <option value="A+">A+</option>
                                                <option value="A">A</option>
                                                <option value="B+">B+</option>
                                                <option value="B">B</option>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="Sub_10" value ="<?php echo $rowt['Sub_10']; ?>" style="height:40px;width:190px;border-radius:8px;font-size:25px;" required></td>
                                    </tr>
